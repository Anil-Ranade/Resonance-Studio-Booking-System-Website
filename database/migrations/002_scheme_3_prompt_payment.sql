-- =====================================================
-- MIGRATION: SCHEME 3 - PROMPT PAYMENT DISCOUNT
-- =====================================================

-- 1. Add is_prompt_payment column to bookings table
ALTER TABLE bookings
ADD COLUMN IF NOT EXISTS is_prompt_payment BOOLEAN DEFAULT FALSE;

-- 2. Update create_booking_atomic function
...
BEGIN
    ...
    -- Check blocked availability slots
    IF EXISTS (
...
-- 3. Update update_booking_atomic function
