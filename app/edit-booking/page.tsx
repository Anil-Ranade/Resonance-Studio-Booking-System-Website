        ...
        {step === "confirm" && selectedBooking && (
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-6">
              ...
              Your original booking will be cancelled when you confirm the new
              booking.
            </p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="space-y-4">
              {bookings.map((booking, index) => {
                ...
                if (
                  editCheck.reason === "Invalid status" ||
                  editCheck.reason === "Past booking"
                )
                  return null;
                ...
                return (
                  <motion.div
                    ...
                    onClick={() =>
                      editCheck.canEdit && handleSelectBooking(booking)
                    }
                  >
                    {/* 24 Hour Warning */}
                    {isWithin24Hours && (
