          ...
          <div className="space-y-3 mb-2">
            <div className="p-3 rounded-lg bg-zinc-800/50 border border-zinc-700/50">
              <p className="text-sm text-zinc-300">
                You have selected <span className="font-bold text-white">{selectedStudio}</span>. 
                Now select a date and we will show available time slots for that studio on the selected date.
              </p>
            </div>
